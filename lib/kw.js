...
(function() {
  var CHR, GLOBAL, TRM, TYPES, font_name_by_rsg, font_name_from_chr_info, font_name_from_rsg, format_cell_by_content, log, njs_util, prefix, read_cells, require, rpr, show_cid, show_objects, show_text_cids, test_format_cells, xray,
    __slice = [].slice;
